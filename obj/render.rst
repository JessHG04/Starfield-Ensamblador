...
Hexadecimal [16-Bits]
                              ...
                              1 ;;FUNCIONES DE DIBUJADO Y BORRADO DE ENTIDADES
...
Hexadecimal [16-Bits]
                              ...
                              3 .include "cpctelera_functions.h.s"
                              1 ;;;;;;;;;;;;;;;;;;;;;;
                              2 ;;                  ;;
                              3 ;; PUBLIC FUNCTIONS ;;
                              4 ;;                  ;;
...
Hexadecimal [16-Bits]
                              ...
                              6 
                              7 ;;CREA UNA PALETA CON COLORES BLANCO, AMARILLO Y NEGRO
   41DC                       8 palette:
   41DC 14 0A 0B 0B           9     .db HW_BLACK            , HW_BRIGHT_YELLOW             , HW_BRIGHT_WHITE               , HW_BRIGHT_WHITE
   41E0 0B 0B 0B 0B          10     .db HW_BRIGHT_WHITE     , HW_BRIGHT_WHITE              , HW_BRIGHT_WHITE               , HW_BRIGHT_WHITE
   41E4 0B 0B 0B 0B          11     .db HW_BRIGHT_WHITE     , HW_BRIGHT_WHITE              , HW_BRIGHT_WHITE               , HW_BRIGHT_WHITE
   41E8 0B 0B 0B 0B          12     .db HW_BRIGHT_WHITE     , HW_BRIGHT_WHITE              , HW_BRIGHT_WHITE               , HW_BRIGHT_WHITE
                             13 
                             14 ;;CAMBIA EL MODO DE VÍDEO A 0, CARGA LA PALETA CREADA ANTERIORMENTE Y PINTA EL FONDO Y LOS BORDES
                             15 ;;DESTRUYE C, HL, DE,     
   41EC                      16 render_init::
   41EC 0E 00         [ 7]   17    ld c, #0
   41EE CD C4 42      [17]   18    call cpct_setVideoMode_asm
   41F1 21 DC 41      [10]   19    ld hl, #palette
   41F4 11 10 00      [10]   20    ld de, #16
   41F7 CD 2B 42      [17]   21    call cpct_setPalette_asm
   001E                      22    cpctm_setBorder_asm HW_BLACK
                              1    .radix h
   001E                       2    cpctm_setBorder_raw_asm \HW_BLACK ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   41FA 21 10 14      [10]    2    ld   hl, #0x1410         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   41FD CD 3E 42      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
   4200 C9            [10]   23 ret
                             24 
                             25 ;;PINTA LAS ENTIDADES
   4201                      26 ent_draw::
                             27     
   4201 11 00 C0      [10]   28     ld      de, #CPCT_VMEM_START_ASM
   4204 DD 4E 00      [19]   29     ld      c,  e_x(ix) 
   4207 DD 46 01      [19]   30     ld      b,  e_y(ix)  
   420A CD AB 43      [17]   31     call cpct_getScreenPtr_asm 
                             32 
   420D EB            [ 4]   33     ex      de, hl
   420E DD 7E 06      [19]   34     ld a, e_color(ix)
   4211 DD 4E 02      [19]   35     ld c, e_w(ix)
   4214 DD 46 03      [19]   36     ld b, e_h(ix)
   4217 CD 06 43      [17]   37     call cpct_drawSolidBox_asm
                             38 
   421A C9            [10]   39 ret
                             40 
                             41 ;;BORRA LAS ENTIDADES (PINTANDO COLOR FONDO ENCIMA)
   421B                      42 ent_clean::
   421B DD 7E 06      [19]   43     ld a, e_color(ix)
   421E 08            [ 4]   44     ex af, af'          
   421F DD 36 06 00   [19]   45     ld e_color(ix), #0
                             46     
   4223 CD 01 42      [17]   47     call ent_draw
                             48 
   4226 08            [ 4]   49     ex af, af'
   4227 DD 77 06      [19]   50     ld e_color(ix), a   ;;Restaura el color original de la entidad
   422A C9            [10]   51 ret
                             52 
