...
<<<<<<< HEAD
                              ...
                              9 
   41A0                      10 rendersys_init::
   41A0 0E 00         [ 7]   11     ld      c, #0x00
   41A2 CD F4 41      [17]   12     call cpct_setVideoMode_asm
   41A5 C9            [10]   13     ret
                             14 ;; INPUT
                             15 ;;      IX: Pointer to first entity to render
                             16 ;;      A: Number of entites to render
   41A6                      17 rendersys_update::
   41A6                      18 _renloop:
   41A6 F5            [11]   19     push    af
   41A7 11 00 C0      [10]   20     ld      de, #0xC000
   41AA DD 4E 00      [19]   21     ld       c, 0(ix)   ;;X
   41AD DD 46 01      [19]   22     ld       b, 1(ix)   ;;Y
   41B0 CD BE 42      [17]   23     call    cpct_getScreenPtr_asm
                             24 
   41B3 EB            [ 4]   25     ex      de, hl
   41B4 DD 7E 06      [19]   26     ld       a, 6(ix)   ;;Color
   41B7 DD 4E 02      [19]   27     ld       c, 2(ix)   ;;Width
   41BA DD 46 03      [19]   28     ld       b, 3(ix)   ;;Height
   41BD CD 19 42      [17]   29     call    cpct_drawSolidBox_asm
                             30 
   41C0 F1            [10]   31     pop     af
   41C1 3D            [ 4]   32     dec     a
   41C2 C8            [11]   33     ret     z
                             34 
   41C3 01 07 00      [10]   35     ld      bc, #entity_size
   41C6 DD 09         [15]   36     add     ix, bc
   41C8 18 DC         [12]   37     jr _renloop
   41CA C9            [10]   38     ret
                             39 
   41CB                      40 rendersys_update_one::
   41CB 11 00 C0      [10]   41     ld      de, #0xC000
   41CE DD 4E 00      [19]   42     ld       c, 0(ix)   ;;X
   41D1 DD 46 01      [19]   43     ld       b, 1(ix)   ;;Y
   41D4 CD BE 42      [17]   44     call    cpct_getScreenPtr_asm
                             45 
   41D7 EB            [ 4]   46     ex      de, hl
   41D8 DD 7E 06      [19]   47     ld       a, 6(ix)   ;;Color
   41DB DD 4E 02      [19]   48     ld       c, 2(ix)   ;;Width
   41DE DD 46 03      [19]   49     ld       b, 3(ix)   ;;Height
   41E1 CD 19 42      [17]   50     call    cpct_drawSolidBox_asm
   41E4 C9            [10]   51     ret
                             52 
                             53 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
<<<<<<< HEAD
                             ...
                             84 ;;    ret
                             85 
   41E5                      86 rendersys_clear::
   41E5 DD 7E 06      [19]   87     ld               a, 6(ix)  
   41E8 08            [ 4]   88     ex              af, af'    
   41E9 DD 36 06 00   [19]   89     ld           6(ix), #0x00
                             90     ;;push ix
                             91     ;;call      entityman_getEntityArray_IX
                             92     ;;call      entityman_getNumEntities_A
   41ED CD CB 41      [17]   93     call      rendersys_update_one ;;Vuelve otro A
                             94     ;;pop ix
   41F0 08            [ 4]   95     ex          af, af'
   41F1 DD 77 06      [19]   96     ld      6(ix),a
=======
                              3 
                              ...
                              7 
   4162                       8 rendersys_init::
   4162 0E 00         [ 7]    9     ld      c, #0x00
   4164 CD B6 41      [17]   10     call cpct_setVideoMode_asm
   4167 C9            [10]   11     ret
                             12 ;; INPUT
                             13 ;;      IX: Pointer to first entity to render
                             14 ;;      A: Number of entites to render
   4168                      15 rendersys_update::
   4168                      16 _renloop:
   4168 F5            [11]   17     push    af
   4169 11 00 C0      [10]   18     ld      de, #0xC000
   416C DD 4E 00      [19]   19     ld       c, 0(ix)   ;;X
   416F DD 46 01      [19]   20     ld       b, 1(ix)   ;;Y
   4172 CD 80 42      [17]   21     call    cpct_getScreenPtr_asm
                             22 
   4175 EB            [ 4]   23     ex      de, hl
   4176 DD 7E 06      [19]   24     ld       a, 6(ix)   ;;Color
   4179 DD 4E 02      [19]   25     ld       c, 2(ix)   ;;Width
   417C DD 46 03      [19]   26     ld       b, 3(ix)   ;;Height
   417F CD DB 41      [17]   27     call    cpct_drawSolidBox_asm
                             28 
   4182 F1            [10]   29     pop     af
   4183 3D            [ 4]   30     dec     a
   4184 C8            [11]   31     ret     z
                             32 
   4185 01 07 00      [10]   33     ld      bc, #entity_size
   4188 DD 09         [15]   34     add     ix, bc
   418A 18 DC         [12]   35     jr _renloop
   418C C9            [10]   36     ret
                             37 
   418D                      38 rendersys_update_one::
   418D 11 00 C0      [10]   39     ld      de, #0xC000
   4190 DD 4E 00      [19]   40     ld       c, 0(ix)   ;;X
   4193 DD 46 01      [19]   41     ld       b, 1(ix)   ;;Y
   4196 CD 80 42      [17]   42     call    cpct_getScreenPtr_asm
                             43 
   4199 EB            [ 4]   44     ex      de, hl
   419A DD 7E 06      [19]   45     ld       a, 6(ix)   ;;Color
   419D DD 4E 02      [19]   46     ld       c, 2(ix)   ;;Width
   41A0 DD 46 03      [19]   47     ld       b, 3(ix)   ;;Height
   41A3 CD DB 41      [17]   48     call    cpct_drawSolidBox_asm
   41A6 C9            [10]   49     ret
                             50 
                             51 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                             ...
                             82 ;;    ret
                             83 
   41A7                      84 rendersys_clear::
   41A7 DD 7E 06      [19]   85     ld               a, 6(ix)  
   41AA 08            [ 4]   86     ex              af, af'    
   41AB DD 36 06 00   [19]   87     ld           6(ix), #0x00
                             88     ;;push ix
                             89     ;;call      entityman_getEntityArray_IX
                             90     ;;call      entityman_getNumEntities_A
   41AF CD 8D 41      [17]   91     call      rendersys_update_one ;;Vuelve otro A
                             92     ;;pop ix
   41B2 08            [ 4]   93     ex          af, af'
   41B3 DD 77 06      [19]   94     ld      6(ix),a
>>>>>>> d68e1e5b0a40643a9891dce6a56874027cf701ae
